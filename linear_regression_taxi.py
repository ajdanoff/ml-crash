...
#mbm = MiniBatchModel(batch=50, epochs=20, learning_rate=0.001)
#mbm.train(training_df['TRIP_MILES'], training_df['FARE'])
...
# print(training_df[['TRIP_MILES', 'TRIP_MINUTES']])
# mbm = MiniBatchModel(batch=50, epochs=20, num_features=2, learning_rate=0.001)
# mbm.train(training_df[['TRIP_MILES', 'TRIP_MINUTES']], training_df['FARE'])
